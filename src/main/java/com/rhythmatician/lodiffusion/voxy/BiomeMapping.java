 ...
 * <ul>
 *   <li>Java inference ({@link AnchorSampler}, {@link WorldNoiseAccess})</li>
...
public final class BiomeMapping {
    ...
    /**
     * Map a {@link RegistryEntry} to its canonical integer ID.
     *
     * @param entry biome registry entry
     * @return canonical ID (0–53) or {@link #UNKNOWN_BIOME_ID} (255)
     */
    public static int toCanonicalId(RegistryEntry<Biome> entry) {
        return entry.getKey()
                .map(key -> toCanonicalId(key.getValue().toString()))
