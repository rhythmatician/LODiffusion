...
noise_3d  : [B, n3d, 4, 2, 4]    13 volumetric fields at 4×2×4 cells per subchunk
biome_ids : [B, 4, 2, 4]         discrete biome IDs at 4×2×4 spatial resolution
ctx       : [B, D]
...
class _NoiseEncoder(nn.Module):
    ...
    Parameters
    ----------
    n2d:                number of 2-D climate channels (default 7, can be 0)
    n3d:                number of 3-D volumetric channels (default 13)
    ...
    def __init__(
        ...
        flat_2d = n2d * 4 * 4
        flat_3d = n3d * 4 * 2 * 4
        flat_biome = 4 * 2 * 4 * biome_embed_dim
    ...
    def forward(
        ...
        Args:
            noise_2d:   [B, n2d, 4, 4]
            noise_3d:   [B, n3d, 4, 2, 4]
            biome_ids:  [B, 4, 2, 4] (integer biome indices)
        Returns:
            ctx: [B, hidden]
        """
        B = noise_2d.shape[0]
        ...
        biome_feat = self.biome_embed(biome_ids_long)  # [B, 4, 2, 4, embed_dim]
...
class SparseRootModel(nn.Module):
    ...
    Parameters
    ----------
    n2d:            2-D noise channel count (default 7, can be 0)
    n3d:            3-D noise channel count (default 13)
